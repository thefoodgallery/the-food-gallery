...
export default function MenuPageLayour({
  ...
  return (
    <main>
      {children}
      <div className="text-center w-full flex justify-center fixed bottom-16">
        <button
          className="text-white flex space-x-2 items-center  bg-black focus:ring-4 focus:ring-yellow-600 font-medium rounded-lg text-sm px-5 py-2.5 mb-2 "
          type="button"
