"use client";
import { CornerDownRight, LogOut, X } from "lucide-react";
      ...
      <>
        ...
        >
          <Drawer.Header
            ...
            className="cursor-pointer px-4 pt-4 bg-gray-50 rounded-t-md hover:bg-gray-100 border-2 border-gray-200"
          />
          <Drawer.Items className="p-4 rounded-t-md">
